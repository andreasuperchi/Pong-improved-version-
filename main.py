...
wn.onkeypress(paddle_b_up, "Up")  # when user presses down w, we call the function paddle_a_up
wn.onkeypress(paddle_b_down, "Down")  # when user presses down s, we call the function paddle_a_down
